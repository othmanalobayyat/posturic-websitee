...
export default function Nav() {
  ...
  return (
    ...
    >
      ...
      >
        <nav className="container-site flex items-center justify-between h-16 md:h-[68px]">
          {/* Logo */}
          ...
          <div className="hidden md:flex items-center gap-0.5">
            {links.map((l) => (
              <a
                key={l.href}
                href={l.href}
                className="px-3.5 py-2 rounded-lg text-[13px] font-medium text-text-muted hover:text-text-primary hover:bg-bg-raised transition-all duration-200"
              >
                {l.label}
              </a>
            ))}
          ...
          <div className="hidden md:flex items-center gap-3">
            <a href="#download" className="btn-primary text-[13px] px-5 py-2.5">
              Download
            </a>
          </div>
          ...
          >
            <div className="container-site py-4 flex flex-col gap-1">
              ...
              <div className="pt-2 border-t border-bg-border mt-2">
                <a
                  href="#download"
                  className="btn-primary text-[14px] px-5 py-3 w-full justify-center"
                >
                  Download
                </a>
              </div>
